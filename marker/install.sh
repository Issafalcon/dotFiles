...
echo ""
echo "  # Using Datalab cloud API (no local RAM needed):"
echo "  # 1. Sign up free at https://www.datalab.to"
echo "  # 2. Add to ~/.zshrc: export DATALAB_API_KEY='your_key'"
echo "  marker_convert /path/to/book.pdf --datalab" 
