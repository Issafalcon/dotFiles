alias dev-proxy='docker run -it --rm -p 80:80 -p 8182:8182 -p 4444:4444 --add-host=host.docker.internal:host-gateway framework-s-staging.tu-server-slv01.corp.waters.com/dev-proxy:latest --cluster scalars-dev --user ukafig --os win' 
