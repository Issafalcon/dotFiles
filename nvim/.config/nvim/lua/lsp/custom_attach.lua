  ...
  if vim.bo.filetype == "cs" then
    vimp.add_buffer_maps(
      function()
        ...
        vimp.nmap({"silent"}, "K", ":Lspsaga hover_doc<CR>")
        -- vimp.nmap({"silent"}, "K", "<Plug>(omnisharp_documentation)") -- Doesn't work well with Omnisharp_vim
        vimp.nmap({"silent"}, "rn", "<cmd>lua vim.lsp.buf.rename()<CR>", opts)
        -- vimp.nmap({"silent"}, "rn", "<Plug>(omnisharp_rename)") -- Doesn't work anymore for Omnisharp_vim
